...
export const BtCate = styled.button`
  ...
  border: 1px solid ${(props) => (props.aaa ? "transparent" : "#e5e5e5")};
  border-radius: 44px;
  background-color: ${(props) => (props.aaa ? "#111" : "#fff")};
  cursor: pointer;
  font-size: 1.4rem;
  color: ${(props) => (props.aaa ? "#fff" : "#111")};
  font-weight: ${(props) => (props.aaa ? 700 : 400)};
`;
